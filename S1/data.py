...
def mnist():
    ...
    train_paths = [f"/home/karol/dtu_mlops/data/corruptmnist/train_{i}.npz" for i in range(5)]
    ...
    X_test = np.load("/home/karol/dtu_mlops/data/corruptmnist/test.npz")["images"]
    Y_test = np.load("/home/karol/dtu_mlops/data/corruptmnist/test.npz")["labels"]
